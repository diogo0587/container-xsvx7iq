...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xsvx7iq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xsvx7iq.containers.anotherwebservice.com/
...
```
git clone git@github.com:diogo0587/container-xsvx7iq.git
cd container-xsvx7iq
```
...
```
docker attach container-xsvx7iq
```
